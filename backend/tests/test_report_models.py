...
from backend.app.models.report_models import AgentArc, InsightForgeResult, TopicEvolutionResult, TopicWindow


def test_insight_forge_result_is_frozen():
    r = InsightForgeResult(
        query="test", sub_queries=("a", "b"), facts=("fact1",), quotable_excerpts=("quote1",), source_agents=("agent1",)
    )
